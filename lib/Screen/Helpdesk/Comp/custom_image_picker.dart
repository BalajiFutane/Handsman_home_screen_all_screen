            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset(
                    "assets/icon/ic_no_photo.png", // Ensure this is a valid asset path
                    height: widget.iconSize ?? 46,
                    width: widget.iconSize ?? 46,
                    fit: BoxFit.cover,
                  ),
                  8.height,
